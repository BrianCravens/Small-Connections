...
const MessageCard = props => {
    ...
    const handleUpdate = (id) => {
        ...
        dataManager.update('messages', updateRequest)
        .then(() => {
            setIsLoading(false)
            props.setToggle(!props.toggle)
        })
    ...
    return(
        <div className='message-card'>
            <div onClick={()=>props.setText("")} onDoubleClick={()=>props.setText(myStuff)} className='message-card-content'>
                ...
                {currentUser==props.message.member.id?
